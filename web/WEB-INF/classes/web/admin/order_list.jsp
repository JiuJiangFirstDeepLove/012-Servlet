...
<form action="/admin/order_list" class="form-inline">
    <div>
        <input type="hidden" id="status" name="status" value="${order.status}">
        <div class="form-group">
            <label>总价：</label>
            <input type="text" class="form-control" placeholder="最小总价" name="minTotal" value="${order.minTotal}">
        </div>
        <div class="form-group">
            <label>-</label>
            <input type="text" class="form-control" placeholder="最大总价" name="maxTotal" value="${order.maxTotal}">
        </div>
...
<div>
    ...
    <div class="form-group">
        <label>订单时间：</label>
        <input type="date" class="form-control" placeholder="开始时间" name="startDate" value="${order.startDate}">
        <input type="date" class="form-control" placeholder="结束时间" name="endDate" value="${order.endDate}">
    </div>

    <button type="submit" class="btn btn-primary">查询</button>
</div>
</form>
<%--	<form action="/admin/order_list">--%>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-danger"
                       href="/admin/order_delete?id=${order.id }&pageNumber=${p.pageNumber}&status=${status}">删除</a>
                </td>
            </tr>
        </c:forEach>
